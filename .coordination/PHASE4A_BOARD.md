...
|------|--------|-------|--------|------------|----------------|------------|-------|
| T1 migration SQL | UNCLAIMED | | | — | `supabase/migrations/**` | 2026-07-18T20:52:04Z | copy spec §2 verbatim |
| T2 database.types + client | UNCLAIMED | | | — | `jsapps/src/lib/**` | 2026-07-18T20:52:04Z | |
| T3 import remapper | UNCLAIMED | | | — | `jsapps/src/services/importRemapper*` | 2026-07-18T20:52:04Z | pure fn + tests |
